...
public class QSuitsDemo2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        paramsMap.put("bucket", "fhyfhy274-src");
        paramsMap.put("to-bucket", "fhyfhy274");
        paramsMap.put("save-tag", "/fhyfhy274");

        // 更新 entryParam 和 qSuitsEntry
        ...
        String saveTag = commonParams.getSaveTag();
        ...
        if (dataSource != null) {
            dataSource.setSaveOptions(saveTotal, saveTag, saveFormat, saveSeparator, rmFields);
...
//        }};
        ...
        for (String bucket : buckets) {
            if (processor != null) {
                processor.updateBucket(bucket);
                processor.updateSavePath("/" + bucket);
            }
            if (dataSource != null) {
                commonParams.setSaveTag("/" + bucket);
                commonParams.setBucket(bucket);
