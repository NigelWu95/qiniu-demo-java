...
public class UploadDemo {
    ...
    String key = "";
    //上传文件的路径
    String filePath = "/Users/wubingheng/Downloads/mescroll.min.css";
    ...
    Zone zone = Zone.zoneAs0();

    Zone pzone = new Zone.Builder().upHttp("http://up.qiniu.com").upHttps("https://up.qbox.me").
    ...
    public void upload() throws IOException {
        try {
            //调用put方法上传
            Response res = uploadManager.put(filePath, "mescroll.min.css", getUpToken());
            //打印返回的信息
